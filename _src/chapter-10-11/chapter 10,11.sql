...
--
-- Table structure for table `content_snippets`
--
...
--
-- Dumping data for table `content_snippets`
--

LOCK TABLES `content_snippets` WRITE;
/*!40000 ALTER TABLE `content_snippets` DISABLE KEYS */;
INSERT INTO `content_snippets` VALUES (3,'<p style=\"text-align: center;\">\n	Kae Verens, provider of stuff and things. Copyright 2010, etc.</p>\n'),(2,'<p>\n	<span style=\"font-size: 10px;\">Kae Verens Ltd.</span></p>\n<p>\n	<span style=\"font-size: 10px;\">15 Haberdashery Row<br />\n	Dublin 43<br />\n	Ireland</span></p>\n<p>\n	<span style=\"font-size: 10px;\">+3531234567</span></p>\n'),(4,'<p>\n	Kae Verens, seller of knicks and knacks. Copyright 2010, etc.</p>'),(5,'<p>\n	this Content Snippet is not yet defined.</p>\n');
/*!40000 ALTER TABLE `content_snippets` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `panels` VALUES (5,'right','{\"widgets\":[{\"type\":\"content-snippet\",\"panel\":\"right\",\"id\":2,\"name\":\"address\",\"header_visibility\":true,\"disabled\":0,\"visibility\":[\"24\"]},{\"type\":\"content-snippet\",\"panel\":\"right\",\"id\":\"5\"}]}','[]',0),(7,'footer','{\"widgets\":[{\"type\":\"content-snippet\",\"panel\":\"footer\",\"id\":\"4\",\"name\":\"legal\"}]}',NULL,0);
...
-- Dump completed on 2010-06-30 14:43:57
